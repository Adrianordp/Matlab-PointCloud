...
%     p11 = map.grid(ix,iy+1);
    ...
    occupancyValue = (dy1_y/map.resolution) * ( (dx_x0*p01)/map.resolution + (dx1_x*p00)/map.resolution) + ...
                     (dy_y0/map.resolution) * ( (dx_x0*p10)/map.resolution + (dx1_x*p11)/map.resolution);
