...
max_x_int = ceil(max_x);
min_x_int = ceil(min_x);
max_y_int = ceil(max_y);
min_y_int = ceil(min_y);

%largura e altura do grid
dx = max_x_int - min_x_int;
dy = max_y_int - min_y_int;
...
division_factor = 1; % 0 < div_factor <= 1
cell_length = g_div*division_factor;
fprintf('Res = %d m\n',cell_length);

% Mesh
xcells = min_x:cell_length:max_x;
...
r = (cell_length/2)*0.95; %raio ~ quadrado de lado 2r!
